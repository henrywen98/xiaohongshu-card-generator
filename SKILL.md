...
name: xhs-image-gen
description: >
  把整篇长文（文章 / 反思 / 教程 / 笔记）自动铺成小红书长图文（多页 PNG 图集），
  暖色版式、按字数和小标题自动分页，每页 1080×1440。当用户说"把这段 / 这篇做成
  小红书长图文 / 长文图 / 图集""发小红书"、或丢来一篇长文 / 反思 / 教程想发
  小红书时使用——即使没说"图片"或"skill"。生成的图片文字会被烧进 PNG，
  发布前会跑一遍违禁词检查。
---
